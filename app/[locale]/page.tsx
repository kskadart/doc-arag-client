...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen flex flex-col" style={{ backgroundColor: '#f0efea' }}>
      ...
      <div
        className="container mx-auto px-8 md:px-12 lg:px-16 pb-16 md:pb-24 max-w-7xl flex-grow"
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-16 md:mb-24" style={{ marginLeft: '10px' }}>
            <h1
              className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 md:mb-10 leading-tight"
            ...
            <p
              className="text-xl md:text-2xl lg:text-3xl max-w-4xl leading-relaxed"
              style={{ color: '#1a1a1a', lineHeight: '1.5' }}
            >
              {t('description')}
            </p>
