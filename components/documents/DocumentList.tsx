...
export function DocumentList({ refreshTrigger = 0 }: DocumentListProps) {
  ...
  if (error) {
    const displayError = error === 'Service is unavailable. Please check your connection.'
      ? t('error.serviceUnavailable')
      : error;
      
    return (
      <div className="flex items-center justify-center" style={{ minHeight: '60vh', paddingTop: '0', marginTop: '-15vh' }}>
        <div className="flex flex-col items-center text-center max-w-md">
          ...
          <button
            ...
            style={{ backgroundColor: '#1a1a1a', color: '#ffffff', paddingLeft: '2.1rem', paddingRight: '2.1rem' }}
          >
            {t('error.retry')}
          </button>
        </div>
