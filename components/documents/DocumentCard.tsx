    ...
    <>
        ...
        <div className="flex items-start justify-between mb-4 gap-3">
          <div className="flex items-start gap-3 flex-1 min-w-0 overflow-hidden">
            ...
            <div className="flex-1 min-w-0 overflow-hidden">
              <h3 className="font-medium text-[var(--md-sys-color-on-surface)] break-words line-clamp-2" title={document.filename}>
                {document.filename}
              </h3>
      ...
      >
        <div className="space-y-4">
          <p className="text-[var(--md-sys-color-on-surface)]" dangerouslySetInnerHTML={{ __html: t('delete.message', { filename: document.filename }) }} />
